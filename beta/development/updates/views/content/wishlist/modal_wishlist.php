...
<div class="modal fade" id="myModalMsg" role="dialog" method="post">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" action='<?php echo site_url('C_wishlist/add_pesan'); ?>' onsubmit="this.btn_submit.disabled = true; this.btn_submit.html = 'Saving...'; ">
          ...
          <div class="modal-footer">
            <input type='submit' class='btn btn-info pull-left submit_btn' value='Save' name="btn_submit">
...
<!-- TAMPILAN MODAL UNTUK ADD FILES  -->
 <div class="modal fade" id="myModalUpload" role="dialog" method="post">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" role="form" action="<?php echo site_url('C_wishlist/uploadfiles/');  ?>" enctype="multipart/form-data" onsubmit="this.submit.disabled = true; this.submit.html = 'Uploading...'; ">
            ...
            <div class="form-group file-row " id="file-row-1">
              <div class="row col-sm-12">
                <div class="controls col-sm-10">
                  <input class="" type="file" name="userfiles[]" required="true">
                </div>
                <div class="col-sm-2">   
...
<div class="modal fade" id="myModalPause" role="dialog" method="post">
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="formpause" class="form-horizontal" method="post" action='<?php echo site_url('C_wishlist/UpStatus/'.$detail['id'].'/3'); ?>' onsubmit="this.submit.disabled = true; this.submit.html = 'Saving...'; ">
          <div class="modal-header">
            <h4>Alasan Pause</h4>
          </div>
          ...
          <div class="modal-footer">
            <input type='submit' class='btn btn-info pull-left submit_btn' value='Save' name="submit">
            <a class="btn btn-default" data-dismiss="modal">Close</a>
          </div>
        </form>
      </div>
...
<div class="modal fade" id="myModalCancel" role="dialog" method="post">
    <div class="modal-dialog">
      <div class="modal-content">
        <form id="formcancel" class="form-horizontal" method="post" action='<?php echo site_url('C_wishlist/UpStatus/'.$detail['id'].'/4'); ?>' onsubmit="this.submit.disabled = true; this.submit.html = 'Uploading...'; ">
          <div class="modal-header">
            <h4>Alasan Cancel</h4>
          </div>
        ...
        <div class="modal-content">
          <form action = "<?php echo site_url('c_wishlist/AddPoint'); ?>" id="form" class="form-horizontal" method = "POST" onsubmit="this.btn_submit.disabled = true; this.btn_submit.html = 'Saving...'; ">
              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="wish_id" value="<?php echo $detail['id'] ?>">
                <input type="hidden" name="wish_to" value="<?php echo $detail['wish_to'] ?>">
              </div>
              <div class="modal-footer">
                  <button type="submit" id="btnSave" class="btn btn-primary" name="btn_submit">Save</button>
                  <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
      ...
      <!-- heading modal -->
        ...
        <form method="post" action="<?php echo site_url('c_ketentuan/simpanSOP') ?>">
          <div class="modal-body">
            ...
            <input type="hidden" value="7" name="nama_modul">
