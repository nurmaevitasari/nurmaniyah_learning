...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="C_delivery/nextTo" onsubmit="this.submit.disabled = true; this.submit.html = 'Saving...'; ">
    ...
    <input type="hidden" name="do_id" value="<?php echo $this->uri->segment(3); ?>">
	<input type="submit" class="btn btn-info submit_btn" value="Save" name="submit"></input>
