			...
			<nav class="navbar-default navbar-side" role="navigation">
				<div class="sidebar-collapse" >
					<ul class="nav" id="main-menu">
                        ...
                        <li>
							<a onClick="popupCenter('<?php echo base_url(); ?>chat', 'chatBox',450,720);" href="javascript:void(0);"><i class="fa fa-comment"></i>Chat <span id="unread"></span></a>
						</li>
...
<!-- =======ADMIN=================================================ADMIN================ -->
						...
						<li>
							...
							<ul class = "nav nav-second-level">
								...
								<li>
									<a href="#"><i class="fa fa-folder-open "></i>Table Point Summary<span class="fa arrow"></span></a>
									<ul class="nav nav-third-level">
										<li>
											<a href="<?php echo site_url('c_point_summary'); ?>" target="_blank"><i class = "fa fa-folder-open"></i>Point Summary Teknisi</a>
										</li>
										<li>
											<a href="<?php echo site_url('C_wishlist/point_summary'); ?>" target="_blank"><i class = "fa fa-folder-open"></i>Point Summary Wishlist</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<?php } ?>
								<li>
									<a target="_blank" href="<?php echo $file_url.'assets/images/upload_hrd/Struktur Organisasi Indotara Persada_260418.pdf'; ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
								<li>
									<a target="_blank" href="<?php echo $file_url.'assets/images/upload_hrd/PERATURAN PERUSAHAAN_HRD 180503.pdf'; ?>"><i class="fa fa-book"></i>Peraturan Perusahaan</a>
								</li>
								<li>
								...
								<li>
									<a target="_blank" href="<?php echo $file_url.'assets/images/upload_hrd/Contact User Indotara Persada(4).pdf'; ?>"><i class="glyphicon glyphicon-book"></i>Contact User Indotara</a>
								</li>
...
<!-- ########## GUEST ####################################### GUEST ########################################### -->
 ...
 global.init();
    ...
    $(".submit_btn").click(function(e) {
      ...
      var textar = $(this).closest('form').find('textarea');
      var len = textar.length;

      $.each(textar, function(i, name) {
        var idtext = textar[i].id;

        var messageLength = CKEDITOR.instances[idtext].getData().replace(/<[^>]>/gi, ' ').length;
        var space = CKEDITOR.instances[idtext].getData().replace(/&nbsp;/gi, '').length;
...
function getNewChat()
{
	$.ajax({
		type: 'GET',
		data: "",
		url: '<?php echo base_url(); ?>chat/unread.php',
