...
class C_tablesps_admin extends CI_Controller {
	...
	public function description($id){
		...
		$sql = "SELECT a.file_name, a.date_created, a.uploader, a.type, b.nickname FROM tbl_upload as a LEFT JOIN tbl_loginuser as b ON b.karyawan_id = a.uploader WHERE a.sps_id = $id ORDER BY a.id ASC";
		$query = $this->db->query($sql);
		$foto = $query->result_array();
