...
class C_tablesps extends CI_Controller {
	...
	public function index()
	{
		...
		if($position == 18){
			...
			$sql	= "SELECT a.job_id, a.divisi, a.jenis_pekerjaan, a.id, a.no_sps, a.date_open, a.areaservis, a.status, a.job_teknisi, a.schedule, a.execution, c.perusahaan, f.nickname, g.nickname as nama, h.status as status_teknisi, i.nickname as nick_tek, a.free_servis, a.status_free, a.date_free, j.nickname as free_name, a.tgl_pembelian FROM tbl_sps as a 
				...
				LEFT JOIN tbl_loginuser as i ON i.karyawan_id = h.karyawan_id
				LEFT JOIN tbl_loginuser as j ON j.karyawan_id = a.user_free
				WHERE a.jenis_pekerjaan != '8' AND a.published = '0' AND (e.overto = $karyawanID OR a.divisi = 'dre' OR e.overto IN ('138')) GROUP BY a.id DESC";
	...
	public function selected($where='')
	{
		...
		if ($position == 29) {
			...
			$sql	= "SELECT a.job_id, a.divisi, a.jenis_pekerjaan, a.id, a.no_sps, a.date_open, a.areaservis, a.status, a.job_teknisi, a.schedule, a.execution, c.perusahaan, f.nickname, g.nickname as nama, h.status as status_teknisi, i.nickname as nick_tek, a.free_servis, a.status_free, a.date_free, j.nickname as free_name, a.tgl_pembelian FROM tbl_sps as a 
				...
				LEFT JOIN tbl_loginuser as i ON i.karyawan_id = h.karyawan_id
				LEFT JOIN tbl_loginuser as j ON j.karyawan_id = a.user_free
				WHERE ".$where." AND (e.overto = $karyawanID OR a.divisi = 'dre' OR e.overto IN ('138')) GROUP BY a.id DESC";
	 ...
	 public function update($id)
	{
		...
		$sql = "SELECT a.file_name, a.date_created, a.uploader, b.nickname FROM tbl_upload as a LEFT JOIN tbl_loginuser as b ON b.karyawan_id = a.uploader WHERE a.sps_id = $id ORDER BY a.id ASC";
		$query = $this->db->query($sql);
		...
		public function add_pesan()
	{
		...
		if(!empty($position_cbg)) {
			$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_upload WHERE sps_id = '$id_sps' GROUP BY uploader UNION SELECT overto, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_sps_log WHERE id_sps = '$id_sps' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_pesan WHERE sps_id = '$id_sps' GROUP BY sender_id UNION SELECT id, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$position_id', '$div')";
		} else {
			$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_upload WHERE sps_id = '$id_sps' GROUP BY uploader UNION SELECT overto, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_sps_log WHERE id_sps = '$id_sps' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_pesan WHERE sps_id = '$id_sps' GROUP BY sender_id UNION SELECT id, '$msg_id', '2', '$id_sps', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$div', '58')";
		}
	...
	public function pause()
	{
		...
		if(!empty($position_cbg)) {
			$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$p', '4', '$id', '0', '3' FROM tbl_upload WHERE sps_id = '$id' GROUP BY uploader UNION SELECT overto, '$p', '4', '$id', '0', '3' FROM tbl_sps_log WHERE id_sps = '$id' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$p', '4', '$id', '0', '3' FROM tbl_pesan WHERE sps_id = '$id' GROUP BY sender_id UNION SELECT id, '$p', '4', '$id', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$position_cbg', '$div')";
		}else {
			$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$p', '4', '$id', '0', '3' FROM tbl_upload WHERE sps_id = '$id' GROUP BY uploader UNION SELECT overto, '$p', '4', '$id', '0', '3' FROM tbl_sps_log WHERE id_sps = '$id' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$p', '4', '$id', '0', '3' FROM tbl_pesan WHERE sps_id = '$id' GROUP BY sender_id UNION SELECT id, '$p', '4', '$id', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$div', '58')";
	...
	public function play($play){
		...
		foreach ($que as $key => $value) { 
			...
			if($que[$key]['pause'] == 1){
				...
				if(!empty($position_cbg)) {
					$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$p', '5', '$play', '0', '3' FROM tbl_upload WHERE sps_id = '$play' GROUP BY uploader UNION SELECT overto, '$p', '5', '$play', '0', '3' FROM tbl_sps_log WHERE id_sps = '$play' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$p', '5', '$play', '0', '3' FROM tbl_pesan WHERE sps_id = '$play' GROUP BY sender_id UNION SELECT id, '$p', '5', '$play', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$position_cbg', '$div')";
				}else {
					$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$p', '5', '$play', '0', '3' FROM tbl_upload WHERE sps_id = '$play' GROUP BY uploader UNION SELECT overto, '$p', '5', '$play', '0', '3' FROM tbl_sps_log WHERE id_sps = '$play' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$p', '5', '$play', '0', '3' FROM tbl_pesan WHERE sps_id = '$play' GROUP BY sender_id UNION SELECT id, '$p', '5', '$play', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('$div', '58')";
				}
	...
	public function schedule()
	{
		...
		foreach ($result as $key => $val) {
			...
			{	
				...
				$sql = "INSERT INTO tbl_notification (user_id, record_id, record_type, modul_id, status, modul) SELECT uploader, '$msg_id', '2', '$idsps', '0', '3' FROM tbl_upload WHERE sps_id = '$idsps' GROUP BY uploader UNION SELECT overto, '$msg_id', '2', '$idsps', '0', '3' FROM tbl_sps_log WHERE id_sps = '$idsps' AND overto != ' ' GROUP BY overto UNION SELECT sender_id, '$msg_id', '2', '$idsps', '0', '3' FROM tbl_pesan WHERE sps_id = '$idsps' GROUP BY sender_id UNION SELECT id, '$msg_id', '2', '$idsps', '0', '3' FROM tbl_karyawan WHERE published = '1' AND position_id IN ('58')";
		 		$this->db->query($sql);
