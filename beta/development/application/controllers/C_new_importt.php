...
class C_new_import extends CI_Controller {
	...
	public function edit($id){
		...
		$sql = "SELECT  a.date_created, a.shipment, a.ship_via, b.nickname, a.info, a.dept, a.arrival, a.kedatangan, a.ship_to FROM tbl_import as a JOIN tbl_loginuser as b ON a.ship_to = b.karyawan_id WHERE a.id = '$id'";
		$que = $this->db->query($sql)->row_array();
