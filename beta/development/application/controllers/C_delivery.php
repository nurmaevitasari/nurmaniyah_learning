...
class C_delivery extends CI_Controller {
	...
	public function index()
	{
		...
		$data['view'] 	 = 'content/delivery/content_delivery';
		$this->load->view('template/home', $data);
	}

	public function term($term) {
		$data['do_jdwl'] = $this->dlv_mdl->_do($term);
		$data['view'] = 'content/delivery/content_delv_fin';
		$this->load->view('template/home', $data);
	}
	...
	{
		if($param == 'it') {
			$view = 'content/delivery/form_new_it';
		}elseif ($param == 'delv') {
			$view = 'content/delivery/form_new_do';
		}	
	...
	public function details($id)
	{
		...
		$data['view']		= 'content/delivery/content_delv_details';
		$this->load->view('template/home', $data);
	}
	...
	public function dataview($do_id)
	{
		...
		$this->load->view('content/delivery/content_delv_dataview', $data);
	}
	...
	public function nextTo()
	{
		...
		$data['view'] = 'content/delivery/content_delv_overto';
		$this->load->view('template/home', $data);
	}
	...
	public function do_receipt($status = 0)
	{
		...
		$data['dlv_mdl'] = $model_delv;
		$data['receipt'] = $result;
		$data['view'] = 'content/delivery/content_delv_receipt';
		$this->load->view('template/home', $data);
	}
	...
	public function add_newdoreceipt()
	{
		...
		$data['cust'] = $cust;
		$data['view'] = 'content/delivery/add_newdoreceipt';
		$this->load->view('template/home', $data);
	}
