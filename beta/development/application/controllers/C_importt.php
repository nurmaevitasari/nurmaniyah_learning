...
class C_import extends CI_Controller {
	...
	{
		$sql = "SELECT a.id, a.sps_id, a.info, a.shipment, a.date_created, a.ship_via, a.dept, a.arrival, a.kedatangan, a.status, a.notes, b.nickname
		FROM tbl_import as a JOIN tbl_loginuser as b ON a.ship_to = b.karyawan_id ORDER BY a.date_created ASC";
	...
	public function Cetakimport($id)
	{
        ...
        $this->load->view('content/print_import', $data);
