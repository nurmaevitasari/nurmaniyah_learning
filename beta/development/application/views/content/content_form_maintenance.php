<div class="form-group">
		...
		<div class="form-group row">
			<label class="control-label col-sm-2" id="area">Area Maintenance</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" name="areaservis" id="areaservis" required>
			</div>
		</div>
		<div class="form-group row">
			<label class="control-label col-sm-2" id = "freq">Maintenance Ke - </label>
			<div class="col-sm-2">
				<input type="text" class="form-control" name="frekuensi" required><p style="font-size : 12px;">*Untuk kasus yang sama</p>
			</div>

			<label class="control-label col-sm-3" id = "schedule">Pengajuan Schedule maintenance</label>
			<div class="col-sm-3">
		...
		<div class="form-group row">
			<label class="control-label col-sm-2">Instruksi Maintenance</label>
			<div class="col-sm-8">
