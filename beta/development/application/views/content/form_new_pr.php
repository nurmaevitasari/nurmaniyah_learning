...
<div id="page-inner">
	...
	<div class="form-group row overto">
	     	<label class="control-label col-sm-2">Purchaser</label>
	      	<div class="col-sm-8">
	        	<select class="form-control" name="purchaser" id="purchaser" required="true" style="width: 100%; margin-top: 3px;">
	                <option value="">-Pilih-</option>
                  	<?php 
                    if($karyawan)
                    {
	...
	<div class="form-group row overto">
	     	<label class="control-label col-sm-2">Receiver</label>
	      	<div class="col-sm-8">
	        	<select class="form-control" name="receiver" id="receiver" required="true" style="width: 100%; margin-top: 3px;">
	                <option value="">-Pilih-</option>
                  	<?php 
                    if($receiver)
                    {
                    	foreach($receiver as $que)
                    	{ ?>
                    	<option value="<?= $que['id']; ?>"><?php echo $que['nama']; ?></option>
                    	<?php 
                    	} 
                    } ?>
	            </select>
    ...
    <div class="form-group row holder" id="holder" name="holder">
			<label class="control-label col-sm-2">Tools Holder</label>
			<div class="col-sm-7">
		...
		<div class="col-sm-12">
			<input type="submit" name="btn_submit" id="submit" value="Next >>" class="btn btn-info" />
		</div>	
				...
				<table class=" table table-hover col-sm-12" id="table-items" style="font-size: 12px;">
					...
					<tbody>
						...
						<!-- 		<center>
							...
							<td>
								 <button type="button" class="btn btn-primary btn-tr-input btn-sm btn-item tombol" data-id="1">+</button>
								 <button type="button" class="btn btn-danger btn-tr-remove btn-sm btn-item tombol" data-id="1">-</button>
							</td>
						</tr>
					</tbody>
				</table>
      ...
      <!-- heading modal -->
        ...
        <form method="post" action="<?php echo site_url('c_ketentuan/simpanSOP') ?>">
          <div class="modal-body">
            ...
            <input type="text" value="5s" name="nama_modul">
            <input type="text" value="<?php echo $this->uri->segment(1)."/".$this->uri->segment(2)."/".$this->uri->segment(3);?>" name="link">
          </div>
          <!-- footer modal -->
