    ...
    <dl class="dl-horizontal" style="font-size: 14px;" >
      ...
      <dd>
        ...
        if($detail['status'] == 0) {
          ...
          if((empty($detail['level_approval']) AND $detail['cabang'] != '' AND $detail['cabang'] != 'Cikupa') OR in_array($detail['position_id'], array('55','56', '57', '95'))) {  
          ...
          }elseif(((empty($detail['level_approval']) AND (in_array($detail['position_id'], array('65','66','67','68','71','72')) AND $detail['cabang'] == ''))) AND !in_array($detail['position_id'], array('88','89','90','91','93'))) {
        ...
        <?php $no = 1;
         ?>
          <tr>
            ...
            <td style="text-align: right;"><strong><?php echo number_format($detail['amount_approved'], "0", ",", "."); ?></strong></td>
          </tr>
        <?php $no++;  ?>
