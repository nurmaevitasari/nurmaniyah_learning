<div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h2>Table Products and Spareparts</h2>
            </div>
        </div>
        <hr />

        <br />
         <?php if($_SESSION['myuser']['position_id'] == '14' OR $_SESSION['myuser']['role_id'] == '9'){ ?>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="product" placeholder="Product" class="form-control" rows="4"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>           
                    </div>
