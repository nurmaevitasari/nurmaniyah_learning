				...
				<?php if($crm) {
					foreach ($crm as $row) { ?>
						<tr>
							...
							<td><?php echo "Rp. ".number_format($row['prospect_value'], "0", ",", "."); ?><br>
							...
							<td><a href="<?php echo site_url('c_crm/details/'.$row['id']); ?>" class="btn btn-default"> Detail</a></td>
						</tr>	
