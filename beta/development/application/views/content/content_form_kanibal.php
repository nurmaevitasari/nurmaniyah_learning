<div class="form-group">
		...
		<div class="form-group">
			<label class="control-label col-sm-2" >Job ID </label>
				<div class="col-sm-8">
					<select class="form-control" name="link_job_id" id="link_job_id" data-placeholder = "Job ID : 100">
					...
					<p style="font-size : 12px;">*Nomor Job ID yang berhubungan dengan komponen.</p>
				</div>
		</div>

		<div class="form-group row">
			<label class="control-label col-sm-2" id="area">Cabang Pelaksana</label>
			<div class="col-sm-3">
				<input type="text" name="areaservis" class="form-control" id = "areaservis" required="">
			</div>			

			<label class="control-label col-sm-2" id = "schedule">Deadline </label>
			<div class="col-sm-3">
				<input type="text" name="jadwal_service" class="form-control" id="jadwal_service" placeholder="dd/mm/yyyy" required>
				<input type="hidden" name="frekuensi" value="0">
			</div>

		</div>
		<div class="form-group row">
			<label class="control-label col-sm-2">Instruksi Kanibal</label>
			<div class="col-sm-8">
