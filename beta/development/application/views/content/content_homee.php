            ...
            <div class="modal-content">
              ...
              <form action="Home/simpan" method="post" onsubmit="this.submit_btn.disabled = true; this.submit_btn.val = 'Saving...'; ">
                <div class="modal-body">
                  <textarea type="text" id="fr2" class="form-control" name="pemberitahuan" placeholder="Isi Pemberitahuan."></textarea>
                </div>
               <!-- footer modal -->
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                  <input type="submit" class="btn btn-primary" value="Simpan" name="submit_btn"> 
                </div>
              </form>
            </div>
          </div>
