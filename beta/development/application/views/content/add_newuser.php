            <div id="page-inner">
				...
				<form class="form-horizontal" action="<?php echo site_url('c_admin/add'); ?>" method="post">
			<h4 color="black" ><?php echo $this->session->flashdata('message'); ?></h4>
				...
				<div class="form-group">
					<label class="control-label col-sm-2"> Front Name :</label>
					<div class="col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<select class="form-control" name="karyawan_id">
							...
							{
							?>
							<option <?php if(!empty($c_admin['karywan_id'])){ if($c_admin['karyawan_id'] == $row['id']){ ?> selected <?php }} ?>value="<?= $row['id']; ?>">
							<?php echo $row['nama']; ?>
							</option>
							<?php 
							}	
