...
<div id="page-inner">
	...
	<form id="form-project" class="form-horizontal" enctype="multipart/form-data" method="post" role="form" onsubmit=" checkDays(event);">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<textarea name="description" class="form-control" placeholder="Contoh : LG GantryCrane 10T Span 22m x Long 60m x 2 Lot"></textarea>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<textarea name="adrs" class="form-control" placeholder="Alamat Lengkap Project" rows="6"></textarea>
			</div>
			<div class="col-sm-6">
				<div class="form-group row">
					<label class="col-sm-4 control-label">Google Maps Link</label>
					<div class="col-sm-8">
						<input type="text" name="glink" class="form-control" placeholder="Contoh : https://goo.gl/maps/Ci96mFdUmAp">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-sm-4 control-label">CP</label>
					<div class="col-sm-8">
						<input type="text" name="siteCP" class="form-control" >
					</div>
				</div>
				<div class="form-group row">
