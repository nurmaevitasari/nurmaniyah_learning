  ...
  <div>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form class="form-horizontal" method="post" action='<?php echo site_url('c_delivery/add_pesan'); ?>' onsubmit="this.btn_submit.disabled = true; this.btn_submit.html = 'Saving...'; ">
          ...
          <div class="modal-footer">
            ...
            <input type='submit' class='btn btn-info  submit_btn' value='Save' name="btn_submit">
          </div>
        </form>
      </div>
    </div>
...
<!-- TAMPILAN MODAL UNTUK ADD FILES  -->
 <div class="modal fade" id="myModalUpload" role="dialog" method="post">
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" role="form" action="<?php echo site_url('C_delivery/uploadfile/');  ?>" enctype="multipart/form-data" onsubmit="this.submit.disabled = true; this.submit.html = 'Saving...'; ">
          ...
          <div class="modal-footer">
            <a class="btn btn-default pull-left " data-dismiss="modal">Close</a>
            <input type="submit" name="submit" id="submit" value="Save" class="btn btn-info submit_btn" />
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form class="form-horizontal" method="post" role="form" action="<?php echo site_url('C_delivery/uploadlink/');  ?>" enctype="multipart/form-data" onsubmit="this.submit.disabled = true; this.submit.html = 'Saving...'; ">
      ...
      <div class="col-sm-6">
      <input type="text" name="file_name" class="form-control" placeholder="Link.." required="true">
      </div>
      </div>
            <input type="hidden" name ="do_id" value="<?php echo $desc['id'];  ?>">
            <input type="hidden" name="jenis" value="<?php echo $this->uri->segment(2); ?>"> 
    ...
    <!-- konten modal-->
      ...
      <!-- heading modal -->
        ...
        <form method="post" action="<?php echo site_url('c_ketentuan/simpanSOP') ?>">
          <div class="modal-body">
            <textarea type="text" id="ketentuan" class="form-control" name="ketentuan" placeholder="Isi Ketentuan."><?= !empty($ketentuan['ketentuan']) ? $ketentuan['ketentuan'] : ''; ?></textarea>
          ...
          <!-- footer modal -->
          <div class="modal-footer">
            <input type="submit" class="btn btn-primary submit_btn" value="Simpan">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form class="form-horizontal" method="post" action='<?php echo site_url('c_delivery/docancel'); ?>' onsubmit="this.submit_btn.disabled = true; this.submit_btn.val = 'Saving...'; ">
          ...
          <br>
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <textarea class="form-control" rows="6" name="msg" required="" id="canceldelv"></textarea>
                <input type="hidden" name ="do_id" value="<?php echo $desc['id']; ?>" />
          ...
          <div class="modal-footer">
            <input type='submit' class='btn btn-info pull-left submit_btn' name="submit_btn" value='Save'>
          ...
          <br>
            <div class="form-group">
              <div class="col-sm-12">
                ...
                <textarea class="form-control" rows="6" name="msg" required="" id="returndelv"></textarea>
                <input type="hidden" name ="do_id" value="<?php echo $desc['id']; ?>" />
                <input type="hidden" name="divisi" value="<?php echo $desc['divisi'] ?>">
                <input type="hidden" name="sales_id" value="<?php echo $desc['sales_id'] ?>">
      ...
      <div class="modal-content">
        <form class="form-horizontal" method="post" action='<?php echo site_url('c_delivery/doreplace'); ?>' onsubmit="this.submit_btn.disabled = true; this.submit_btn.val = 'Saving...'; ">
          ...
          <br>
            <div class="form-group">
              <div class="col-sm-12">
                <textarea class="form-control" rows="6" name="msg" required="" id="replacedelv"></textarea>
                <input type="hidden" name ="do_id" value="<?php echo $desc['id']; ?>" />
                <input type="hidden" name="divisi" value="<?php echo $desc['divisi'] ?>">
                <input type="hidden" name="sales_id" value="<?php echo $desc['sales_id'] ?>">
      ...
      <div class="modal-content">
        <form class="form-horizontal" method="post" action='<?php echo site_url('c_delivery/notapproved'); ?>' onsubmit="this.submit_btn.disabled = true; this.submit_btn.val = 'Saving...'; ">
          ...
          <br>
            <div class="form-group">
              <div class="col-sm-12">
                <textarea class="form-control" rows="6" name="msg" required="" id="notapprdelv"></textarea>
                <input type="hidden" name ="do_id" value="<?php echo $desc['id']; ?>" />
