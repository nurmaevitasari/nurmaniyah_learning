...
<div id="page-inner">
	...
	<form class="form-horizontal" method="post" role="form" action="<?php echo site_url($action);  ?>" enctype="multipart/form-data">
			...
			<label>** Filled according to Accurate **</label>
		<br>
		
		 <div class="form-group row">
			<label class="control-label col-sm-2">PI Date</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="order" id="order" value="<?= !empty($edit_import['date_pi']) ? $edit_import['date_pi'] : ''; ?>" required>
			</div>
		</div>
		<div class="form-group row">
...
<!--		<div class="form-group row">
    ...
    <div class="form-group row">
		...
		<div class="form-group row">
			<label class="control-label col-sm-2">Arrival Destination</label>
				<div class="col-sm-4">
		...
		<div class="form-group row">
			<label class="control-label col-sm-2">Item Info</label>
			<div class="col-sm-4">
      ...
      <label class="control-label col-sm-2">Upload Attachment</label>
