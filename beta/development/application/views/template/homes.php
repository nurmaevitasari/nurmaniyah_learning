...
<!-- =======ADMIN=================================================ADMIN================ -->
						...
						<li>
							...
							<ul class = "nav nav-second-level">
								...
								<li>
									<a href="<?php echo base_url('assets/images/upload_spt/pph21+memo.pdf'); ?>" target="_blank"><i class="fa fa-file-text"></i> Memo Pph21</a>
								</li>
								<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="<?php echo site_url('C_crm/crm/og'); ?>"><i class="fa fa-table"></i>Table CRM</a>
								</li>
								<li>
									<a href="<?php echo site_url('C_crm/crm/fin'); ?>"><i class="fa fa-table"></i>Dealt CRM</a>
								</li>
								<li>
									<a href="<?php echo site_url('C_crm/crm/lost'); ?>"><i class="fa fa-table"></i>Lost CRM</a>
								</li>
							</ul>
						</li>
						<?php if(in_array($user['position_id'], array('1', '2', '3', '55', '56', '57', '58', '95', '73', '14'))) { ?>
							<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Struktur Organisasi Indotara Persada_201117.pdf'); ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
								<li>
								...
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Contact User Indotara Persada(1).pdf'); ?>"><i class="glyphicon glyphicon-book"></i>Contact User Indotara</a>
								</li>
								<li>
...
<!-- =======SALES============================================SALES================ -->
						...
						<?php if(in_array($user['position_id'], array('15','65','88'))) { ?>
							<li>
								<a href="<?php echo site_url('project'); ?>"><i class="fa fa-table"></i>Project DHC</a>
							</li>
						<?php } ?>
...
<!-- =========TEKNISI===============================================TEKNISI=================== -->
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<!-- <li>
									<a href="<?php //echo site_url('c_new_sps/Rekondisi'); ?>"><i class="fa fa-edit"></i>New SPS</a>
								</li> -->
								<li>
									<a href="<?php echo site_url('C_tablesps/selected/'); ?>"><i class="fa fa-table"></i>Table SPS</a>
								</li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<?php if (in_array($user['position_id'], array('27', '28', '29', '30'))): ?>
