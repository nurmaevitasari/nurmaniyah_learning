			...
			<nav class="navbar-default navbar-side" role="navigation">
				<div class="sidebar-collapse" >
					<ul class="nav" id="main-menu">
						...
						<li>
							<a  href="<?php echo site_url('home/logout'); ?>"><i class="fa fa-power-off"></i>Logout</a>
						</li>
...
<!-- =======ADMIN=================================================ADMIN================ -->
						...
						<!-- <li>
							<a href="<?php echo site_url('imagecompressor'); ?>"><i class="fa fa-picture-o"></i>Image Compressor</a>
						</li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('tools'); ?>"><i class="fa fa-user"></i> List Holder Tools</a>
								</li>
								<li>
									<a href="<?php echo site_url('tools/list_tools'); ?>"><i class="fa fa-list"></i> List Tools</a>
								</li>
							</ul>
						</li>

						<li>
							<a href="<?php echo site_url('import'); ?>"><i class="glyphicon glyphicon-import"></i>Import</a>
						</li>

						<li>
							<a href="<?php echo site_url('purchasing'); ?>"><i class="glyphicon glyphicon-shopping-cart"></i>Purchasing</a>
						</li>

						<li>
							<a href="#"><i class="fa fa-cogs"></i>Delivery<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('delivery/term'); ?>"><i class="fa fa-list"></i> List Delivery</a>
								</li>

								<li>
									<a href="<?php echo site_url('delivery/do_receipt'); ?>"><i class="fa fa-list"></i> Serah Terima DO</a>
								</li>
						...
						<li>
							<a href="<?php echo site_url('sps'); ?>"><i class="fa fa-list"></i>Sps</a>
						</li> -->
						...
						<li>
							...
							<ul class = "nav nav-second-level">
								...
								<?php if(in_array($user['position_id'], array('1', '2', '14'))) { ?>
									<li>
								...
								<?php } ?>
								<?php if($user['role_id'] == 1 AND $user['position_id'] != 87){ ?>
								<li>
								...
								<li>
									...
									<ul class="nav nav-third-level">
										<li>
											<a href="<?php echo base_url('assets/images/upload_spt/EFiling SPT 1770 S.mp4'); ?>" target="_blank"><i class="fa fa-film"></i>EFiling SPT 1770 S.mp4</a>
										</li>
										<li>
											<a href="<?php echo base_url('assets/images/upload_spt/EFiling SPT 1770 SS.mp4'); ?>" target="_blank"><i class="fa fa-film"></i>EFiling SPT 1770 SS.mp4</a>
										</li>
									</ul>
								</li>
								<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('C_crm/add'); ?>"><i class="fa fa-edit"></i>New CRM</a>
								</li>
								<li>
									<a href="<?php echo site_url('C_crm'); ?>"><i class="fa fa-table"></i>Table CRM</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="nav nav-second-level">
									<li>
										<a href="<?php echo site_url('c_new_sps/add'); ?>"><i class="fa fa-edit"></i>New SPS</a>
									</li>
									<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('C_delivery/add'); ?>"><i class="fa fa-edit"></i>New Delivery</a>
								</li>
								<li>
						...
						<?php if($user['position_id'] == '13' OR $user['position_id'] == '14' OR $user['position_id'] == '87') { ?>
							<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Struktur Organisasi Indotara Persada_021017.pdf'); ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/PERATURAN PERUSAHAAN_HRD 170315.pdf'); ?>"><i class="fa fa-book"></i>Peraturan Perusahaan</a>
								</li>
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/PERATURAN MESS PERUSAHAAN.pdf'); ?>"><i class="fa fa-home"></i>Peraturan Mess Perusahaan</a>
								</li>
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Contact User Indotara Persada_20170505.pdf'); ?>"><i class="glyphicon glyphicon-book"></i>Contact User Indotara</a>
								</li>
								<li>
...
<!-- =======SALES============================================SALES================ -->
						...
						<li>
							...
							<ul class = "nav nav-second-level">
								...
								<?php if(in_array($user['position_id'], array('88', '89', '90', '91', '93'))) { ?>
									<li>
									<a href="<?php echo site_url('c_upload_qc'); ?>"><i class="fa fa-folder-open"></i>Files QC</a>
								</li>
								<?php	} ?>
						...
						if($user['position_id'] == 88 OR $user['position_id'] == 89 OR $user['position_id'] == 90 OR $user['position_id'] == 91 OR $user['position_id'] == 92 OR $user['position_id'] == 93) { ?>
							<li>
								<a href="#"><i class="fa fa-book"></i>MY SOP<span class="fa arrow"></span></a>
								<ul class="nav nav-second-level">
									<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php echo site_url('c_employee'); ?>"><i class="fa fa-list"></i>Employees</a>
								</li>
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Struktur Organisasi Indotara Persada_021017.pdf'); ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<?php if (($user['karyawan_id'] == 2) OR ($user['karyawan_id'] == 4)): ?>
								<li>
...
<!-- ==========FINANCE / ACCOUNTING=============================FINANCE/ACCOUNTING=========== -->
						...
						<li>
							...
							<li>
								<a href="<?php echo site_url('c_admin'); ?>"><i class="fa fa-list"></i>Users</a>
							</li>
							...
							<li>
								<a href="<?php echo site_url('c_position'); ?>"><i class="fa fa-list"></i>Positions</a>
							</li>
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Struktur Organisasi Indotara Persada_021017.pdf'); ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
...
<!-- ===========HRD=============HRD============================HRD==================== -->
						...
						<!-- <li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a href="<?php //echo site_url('C_tablesps'); ?>">Table SPS</a>
								</li>
								<li>
									<a href="<?php //echo site_url('C_tablesps/persiapanbrg'); ?>">SPS Persiapan Barang</a>
								</li>
							</ul>
						</li> -->
						<li>
...
<!-- ########## GUEST ####################################### GUEST ########################################### -->
						...
						<li>
							<a href="<?php echo site_url('tools'); ?>"><i class="fa fa-cogs"></i>Tools</a>
						</li> -->
