...
<!-- =======ADMIN=================================================ADMIN================ --> 						
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a href="<?php echo site_url('C_delivery'); ?>"><i class="fa fa-table"></i>Table Delivery</a>
								</li>
								<li>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a target="_blank" href="<?php echo base_url('assets/images/upload_hrd/Struktur Organisasi Indotara Persada_110817.pdf'); ?>"><i class="fa fa-sitemap"></i>Struktur Organisasi</a>
								</li>
								<li>
...
<!-- =========TEKNISI===============================================TEKNISI=================== -->
						...
						<li>
							<a href="<?php echo site_url('C_delivery'); ?>"><i class="fa fa-table "></i>Delivery</a>
						</li>
						<li>
							<a href="#"><i class="fa fa-book"></i>MY SOP<span class="fa arrow"></span></a>
