<?php if(! defined('BASEPATH')) exit('No direct script access allowed');
	...
	*/
	class M_purchasing extends CI_Model
	{
		...
		{
			$sql = "SELECT pr.*, lg.nickname,stl.nickname as name , lgn.nickname as nama, ps.position, kr.cabang, kr.position_id, stlg.nickname as ov_name, cont.cont_name FROM tbl_purchasing pr
