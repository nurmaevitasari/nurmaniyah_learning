...
<!-- /. ROW  -->
	...
	<dl class="dl-horizontal" style="font-size: 14px;">
		...
		<?php if($link_modul) {
			if($link_modul['link_from_modul'] == '8') {
				$url = site_url('c_crm/details/'.$link_modul['link_from_id']);
			}elseif($link_modul['link_from_modul'] == '9') {
		...
		if(!empty($link))
          {
             foreach($link as $ln)
			  ...
			  <div class="<?php 
                ...
                <b style = "color : #3992b0"><?php echo $ln['nickname']; ?> : </b>
