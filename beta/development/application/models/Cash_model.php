<?php if(! defined('BASEPATH')) exit('No direct script access allowed');    
    ...
    class Cash_model extends CI_Model
    {
        ...
        {
            $sql = "SELECT psn.cash_id, psn.pesan, psn.date_created, lg.nickname, psn.type FROM tbl_cash_pesan as psn
        ...
        {
            $sql = "SELECT psn.cash_id, psn.pesan, psn.date_created, lg.nickname, ps.position, psn.type
