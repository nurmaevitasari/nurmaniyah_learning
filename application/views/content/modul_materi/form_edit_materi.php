...
<div id="page-inner">
        ...
        <form class="form-horizontal" method="POST"  role="form" enctype="multipart/form-data" action="<?php echo site_url('modul_materi/edit_new_process'); ?>" onsubmit="return validate(this); ">
          ...
          <div class="col-sm-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        <input name="nama_materi" type="text" required="true" class="form-control" value="<?php echo $detail['nama_materi'];?>">
                    </div>
                </div> 
                <br>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                         <select name="kelas" required="true" style="width:100%;">
                            ...
                            <option value="10" <?php if($detail['kelas'] =='10'){ echo "selected"; }?> >Kelas 10</option>                                
                            <option value="11" <?php if($detail['kelas'] =='1'){ echo "selected"; }?> >kelas 11</option>          
                             <option value="12" <?php if($detail['kelas'] =='12'){ echo "selected"; }?> >Kelas12</option>                           
                        </select>
                    </div>
                </div> 
                <br>
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                         <textarea name="materi" class="form-control"><?php echo $text['materi'];?> </textarea>
                    </div>
                </div> 
                <br>
            </div>
            ...
            <div class="text-right">
             <button type="submit" name="simpan" class="btn btn-success pull-right btn-md btn-add">Update Materi</button>
            </div>
