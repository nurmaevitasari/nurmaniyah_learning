...
<div id="page-inner">
        ...
        <form class="form-horizontal" method="POST"  role="form" enctype="multipart/form-data" action="<?php echo site_url('data_siswa/add_new_process'); ?>" onsubmit="return validate(this); ">
          ...
          <div class="col-sm-12">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        <input name="kelas" type="text" required="true" class="form-control">
                    </div>
                </div> 
                <br>
            </div>
            ...
            <div class="text-right">
             <button type="submit" name="simpan" class="btn btn-success pull-right btn-md btn-add">Tambah Data Siswa</button>
            </div>
