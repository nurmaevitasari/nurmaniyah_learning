<?php if(! defined('BASEPATH')) exit('No direct script access allowed');  
  ...
  */
  class M_data_guru extends CI_Model
  {
    ...
    {
        $sql ="SELECT tbl_data_guru.*, username,password,tbl_user.id as id_usr,tbl_user.status FROM tbl_data_guru 
              LEFT JOIN tbl_user ON tbl_user.id_user = tbl_data_guru.id  AND role_id !='3'
    ...
    {
        $sql ="SELECT tbl_data_guru.*, username,password,tbl_user.id as id_usr,tbl_user.status,tbl_user.role_id FROM tbl_data_guru 
              LEFT JOIN tbl_user ON tbl_user.id_user = tbl_data_guru.id  AND role_id !='3'
              WHERE tbl_data_guru.id ='$id'";
    ...
    public function add_new_process()
    {
       if($this->input->post())
       {
          ...
          if($_FILES)
          {
              ...
              $this->db->insert('tbl_data_guru',$insert);
