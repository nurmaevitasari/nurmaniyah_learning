      ...
      _alljava: function(){
        ...
        _dataCRM: function(){
            ...
            $(document).ready(function() {
                TABLE = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": options.siteURL + "daily_routine/ajax_list",
                        "type": "POST"
                    },
                    "columnDefs": [
                    ],
        ...
        _selectData: function()
        {
            ...
            $('#select-crm').change(function()
            {
                ...
                {
                    $('#load-data').show();
                    TABLE.ajax.url(options.siteURL + "daily_routine/ajax_list/"+val).load();
                ...
                else
                {
                    ...
                    TABLE.ajax.url(options.siteURL + "daily_routine/ajax_list").load();
