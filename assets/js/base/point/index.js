        ...
        _selectData: function(){
            ...
            $('#bulan').change(function(){
                ...
                if(val != '' || data !='')
                {
                    ...
                    $('#load-data').show();
                    TABLE.ajax.url(options.siteURL + "point/ajax_list/"+val+'/'+data).load();
                    setTimeout(function () 
                    {
                        $('#load-data').hide();
            ...
            $('#select').change(function(){
                ...
                var data = $('#select').val();
                    ...
                    if(bulan != '' || data !='')
                    {
                        ...
                        $('#load-data').show();
                        TABLE.ajax.url(options.siteURL + "point/ajax_list/"+bulan+'/'+data).load();
                        setTimeout(function () 
                        {
                            $('#load-data').hide();
                      ...
                      success : function(data) 
                      {
                        ...
                        $.each(data, function(i, arr) 
                        {
                          ...
                          switch (arr.modul)
                          {
                            ...
                            modul  ="Purchasing";
                            modul_id = arr.modul_id; 
                            link1 = options.siteURL +'purchasing/details/'+modul_id;
                            ...
                            modul = 'Inquiry';
                            modul_id = arr.modul_id;
                            link = modul_id; // nurma 29/06/2020
                            break;
                            ...
                            modul1 = 'surduk';
                            modul_id = arr.modul_id;
                            link1 = options.siteURL + modul1+'/detail_surduk/'+modul_id;
                            link = '<a href="'+link1+'">'+modul_id+'</a>';
                            break;

                            case "37":
                            modul = 'Video Production';
                            modul1 = 'Video_production';
                            modul_id = arr.modul_id;
                            link1 = options.siteURL + modul1+'/details/'+modul_id;
                            link = '<a href="'+link1+'">'+modul_id+'</a>';
                            break;
                            ...
                            modul1 = 'Artikel';
                            modul_id = arr.modul_id;
                            link1 = options.siteURL + modul1+'/detail_artikel/'+modul_id;
                            link = '<a href="'+link1+'">'+modul_id+'</a>';
                            break;
