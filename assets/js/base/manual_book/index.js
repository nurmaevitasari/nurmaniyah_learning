      ...
      _alljava: function(){
        ...
        _dataDHC: function(){
            ...
            $(document).ready(function() {
                TABLE = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": options.siteURL + "manual_book/ajax_list",
                        "type": "POST"
                    },
        ...
        _selectData: function()
        {
            ...
            $('#select-crm').change(function()
            {
                ...
                if(val != '')
                {
                    ...
                    TABLE.ajax.url(options.siteURL + "manual_book/ajax_list/"+val).load();
                ...
                else
                {
                    ...
                    TABLE.ajax.url(options.siteURL + "manual_book/ajax_list").load();
        ...
        change:function(e)
        {
                ...
                var status =$(e).html();     
                    ...
                    $.ajax({
                        type : 'POST',
                        url : options.siteURL + 'manual_book/changests',
                        data: 
                        {
                            id : id,
                            status : status, 
